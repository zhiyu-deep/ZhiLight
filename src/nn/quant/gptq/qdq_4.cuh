...
{
    const uint32_t H2_1024 = 0x64006400; // half2 of 1024

    uint32_t qa = q_0;
    half2_uint32 q0((qa & 0x000f000f) | H2_1024); // half2( q[0]      + 1024, q[1]      + 1024 )
    half2_uint32 q1((qa & 0x00f000f0) | H2_1024); // half2( q[2] * 16 + 1024, q[3] * 16 + 1024 )
    qa >>= 8;
    half2_uint32 q2((qa & 0x000f000f) | H2_1024); // half2( q[4]      + 1024, q[5]      + 1024 )
    half2_uint32 q3((qa & 0x00f000f0) | H2_1024); // half2( q[6] * 16 + 1024, q[7] * 16 + 1024 )
