...
class OpenAIServingCompletion(OpenAIServing):
    ...
    async def create_completion(self, request: CompletionRequest,
        ...
        # 合并的Generator，每个sub_generator生成一个prompt的多条结果
            ...
            async for prompt_idx, res in result_generator:
                ...
                for output in res.outputs:
                    ...
                    if output.finish_reason is not None:  # return final usage
                        ...
                        prompt_tokens = res.prompt_token_ids_num
                        completion_tokens = output.token_ids_num
    ...
    # 将所有的输出结果和统计信息转化成response结构
    def request_output_to_completion_response(
        self,
        final_res_batch: List[RequestOutput], # 每个RequestOutput代表一个输出文本串
        request: CompletionRequest,
        request_id: str,
        created_time: int,
        model_name: str,
        ...
        for final_res in final_res_batch:
            ...
            num_prompt_tokens += final_res.prompt_token_ids_num
