...
public:
    ...
    const std::vector<int>& get_layer_devices() const { return layer_devices; }
    size_t get_num_layers() const { return num_layers; }
    bool is_BSHD() const { return BSHD; }
    void set_continuous(bool b) { continuous = b; }
};
...
struct KVCacheConfig {
    ...
    bool is_quant() const { return scale_dtype.get(); }
};
