...
public:
    BufferContext(const ModelBase& md, bool parallel = false) : model_(md), parallel_(parallel) {};
...
public:
    ...
    bool is_BSHD() override { return BSHD; }
    KVCache* buf_k() override { return buf_k_.get(); }
    KVCache* buf_v() override { return buf_v_.get(); }
    ...
    size_t kvcache_len() { return kvcache_len_; };
};
...
public:
    ...
    bool is_BSHD() override { return true; }
    KVCache* buf_k() override { return nullptr; }
    KVCache* buf_v() override { return nullptr; }
    Tensor* buf_k(size_t layer) override;
    Tensor* buf_v(size_t layer) override;
